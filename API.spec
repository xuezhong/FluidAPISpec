...
paddle.fluid.switch_startup_program ArgSpec(args=['program'], varargs=None, keywords=None, defaults=None)
paddle.fluid.switch_main_program ArgSpec(args=['program'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.switch_scope ArgSpec(args=['scope'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.Trainer.__init__ ArgSpec(args=['self', 'train_func', 'optimizer', 'param_path', 'place', 'parallel'], varargs=None, keywords=None, defaults=(None, None, False))
...
paddle.fluid.DistributeTranspiler.transpile ArgSpec(args=['self', 'trainer_id', 'program', 'pservers', 'trainers', 'split_method', 'sync_mode'], varargs=None, keywords=None, defaults=(None, '127.0.0.1:6174', 1, <class 'paddle.fluid.transpiler.ps_dispatcher.RoundRobin'>, True))
...
paddle.fluid.SimpleDistributeTranspiler.get_pserver_program ArgSpec(args=['self', 'endpoint', 'optimize_ops'], varargs=None, keywords=None, defaults=None)
paddle.fluid.SimpleDistributeTranspiler.get_trainer_program ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.SimpleDistributeTranspiler.transpile ArgSpec(args=['self', 'optimize_ops', 'params_grads', 'program', 'pservers', 'trainers', 'split_method'], varargs=None, keywords=None, defaults=(None, '127.0.0.1:6174', 1, <function round_robin at 0x53009b0>))
paddle.fluid.memory_optimize ArgSpec(args=['input_program', 'print_log', 'level'], varargs=None, keywords=None, defaults=(False, 0))
paddle.fluid.release_memory ArgSpec(args=['input_program'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.ParallelExecutor.run ArgSpec(args=['self', 'fetch_list', 'feed', 'feed_dict'], varargs=None, keywords=None, defaults=(None, None))
...
paddle.fluid.create_lod_tensor ArgSpec(args=['data', 'lod', 'place'], varargs=None, keywords=None, defaults=None)
paddle.fluid.create_random_int_lodtensor ArgSpec(args=['lod', 'base_shape', 'place', 'low', 'high'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.io.save_checkpoint ArgSpec(args=['executor', 'checkpoint_dir', 'max_num_checkpoints', 'save_interval_secs', 'main_program'], varargs=None, keywords=None, defaults=(None, 3, 600, None))
paddle.fluid.io.load_checkpoint ArgSpec(args=['executor', 'checkpoint_dir', 'main_program'], varargs=None, keywords=None, defaults=(None, None))
...
paddle.fluid.layers.fc ArgSpec(args=['input', 'size', 'num_flatten_dims', 'param_attr', 'bias_attr', 'use_cudnn', 'use_mkldnn', 'act', 'is_test', 'name'], varargs=None, keywords=None, defaults=(1, None, None, False, False, None, False, None))
paddle.fluid.layers.embedding ArgSpec(args=['input', 'size', 'is_sparse', 'is_distributed', 'padding_idx', 'param_attr', 'dtype'], varargs=None, keywords=None, defaults=(False, False, None, None, 'float32'))
paddle.fluid.layers.dynamic_lstm ArgSpec(args=['input', 'size', 'param_attr', 'bias_attr', 'use_peepholes', 'is_reverse', 'gate_activation', 'cell_activation', 'candidate_activation', 'dtype', 'name'], varargs=None, keywords=None, defaults=(None, None, True, False, 'sigmoid', 'tanh', 'tanh', 'float32', None))
...
paddle.fluid.layers.batch_norm ArgSpec(args=['input', 'act', 'is_test', 'momentum', 'epsilon', 'param_attr', 'bias_attr', 'data_layout', 'in_place', 'use_mkldnn', 'name', 'moving_mean_name', 'moving_variance_name', 'do_model_average_for_mean_and_var'], varargs=None, keywords=None, defaults=(None, False, 0.9, 1e-05, None, None, 'NCHW', False, False, None, None, None, False))
paddle.fluid.layers.beam_search_decode ArgSpec(args=['ids', 'scores', 'name'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.layers.edit_distance ArgSpec(args=['input', 'label', 'normalized', 'ignored_tokens', 'name'], varargs=None, keywords=None, defaults=(True, None, None))
...
paddle.fluid.layers.beam_search ArgSpec(args=['pre_ids', 'ids', 'scores', 'beam_size', 'end_id', 'level'], varargs=None, keywords=None, defaults=(0,))
...
paddle.fluid.layers.upsampling_bilinear2d ArgSpec(args=['input', 'out_shape', 'scale', 'name'], varargs=None, keywords=None, defaults=(None, None, None))
paddle.fluid.layers.random_crop ArgSpec(args=['input', 'shape', 'seed'], varargs=None, keywords=None, defaults=(1,))
...
paddle.fluid.layers.Send ArgSpec(args=['endpoints', 'send_vars', 'get_vars'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.layers.open_recordio_file ArgSpec(args=['filename', 'shapes', 'lod_levels', 'dtypes', 'pass_num', 'for_parallel'], varargs=None, keywords=None, defaults=(1, True))
paddle.fluid.layers.open_files ArgSpec(args=['filenames', 'shapes', 'lod_levels', 'dtypes', 'thread_num', 'buffer_size', 'pass_num', 'for_parallel'], varargs=None, keywords=None, defaults=(None, 1, True))
paddle.fluid.layers.read_file ArgSpec(args=['file_obj'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.layers.less_than ArgSpec(args=['x', 'y', 'force_cpu', 'cond'], varargs=None, keywords='ignored', defaults=(True, None))
...
paddle.fluid.layers.uniform_random ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
...
paddle.fluid.layers.cumsum ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
...
paddle.fluid.layers.relu ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
...
paddle.fluid.layers.log ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
...
paddle.fluid.layers.hard_shrink ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.layers.thresholded_relu ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
...
paddle.fluid.optimizer.ModelAverage.__init__ ArgSpec(args=['self', 'average_window_rate', 'params_grads', 'min_average_window', 'max_average_window'], varargs=None, keywords='kwargs', defaults=(None, 10000, 10000))
...
paddle.fluid.optimizer.Optimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'regularization'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.regularizer.WeightDecayRegularizer.__init__ ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.ParamAttr.__init__ ArgSpec(args=['self', 'name', 'initializer', 'learning_rate', 'regularizer', 'trainable', 'gradient_clip', 'do_model_average'], varargs=None, keywords=None, defaults=(None, None, 1.0, None, True, None, None))
...
paddle.fluid.clip.append_gradient_clip_ops ArgSpec(args=['param_grad'], varargs=None, keywords=None, defaults=None)
paddle.fluid.clip.error_clip_callback ArgSpec(args=['block', 'context'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.unique_name.UniqueNameGenerator.__init__ ArgSpec(args=['self', 'prefix'], varargs=None, keywords=None, defaults=(None,))
