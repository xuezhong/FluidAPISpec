...
paddle.fluid.io.save_checkpoint ArgSpec(args=['executor', 'checkpoint_dir', 'trainer_id', 'trainer_args', 'main_program', 'max_num_checkpoints'], varargs=None, keywords=None, defaults=(None, None, 3))
